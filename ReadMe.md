...
|Name|Beschreibung|
|---|---|
|*Artist und Album*|Geben Sie den Namen des Artisten und die Titeln der Alben aus.|
|*Artist und Titeln*|Geben Sie den Namen des Artisten und die Namen der Songs aus.|
|*Artist und Songzeit*|Geben Sie den Namen des Artisten, die gesamte Songzeit [sec] und die durchschnittliche Songzeit [sec] aus.|
